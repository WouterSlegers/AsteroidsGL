package com.wjslegers.asteroidsgl.Input;

import android.view.MotionEvent;
import android.view.View;

import com.wjslegers.asteroidsgl.R;

import static com.wjslegers.asteroidsgl.Entities.GLEntity._game;
...
public class TouchController extends InputManager implements View.OnTouchListener{
    ...
    public boolean onTouch(final View v, final MotionEvent event) {
        ...
        if(action == MotionEvent.ACTION_DOWN){
            ...
            if (!_game._isRunning) {
                if (_game._timerOnGameOver <= 0) {
                    _game._isRunning = true;
                }
            }
